...
- **Presentation Layer** → Browser / Apache Web Server (WordPress)  
- **Application Layer** → WordPress + PHP (on Red Hat Server)  
- **Database Layer** → MySQL DB Server (on separate Red Hat Server)  
